...
function NewVesselRequest() {
  const [request,setDonation]=useState({desc:"",no_person:"",quantity:"",requesttype:"vessel",source:"",mob_no:""})
    ...
    <div className="row">
        <div className="col-xl-10 m-auto">
            <form method="POST" className={`form-group bg-light p-3 ${signupstyles.signupformgroup}`}>
                <h2 className={`mb-5 ${signupstyles.h2}`}>Request For Vessel</h2>
                <div className="row">
...
export default NewVesselRequest