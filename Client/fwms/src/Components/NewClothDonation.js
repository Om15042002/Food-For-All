...
function NewClothDonation() {
  ...
  const PostData=async (e)=>{
      ...
      const res=await fetch('/donatecloth',{
          method:"POST",
          headers:{
            ...
            <form method="POST" className={`form-group bg-light p-3 ${signupstyles.signupformgroup}`}>
                ...
                <div className="row"> 
                    <div className="m-auto col-md-10">
                        ...
                        <div className="mb-3">
                            <label htmlFor="quantity" className="form-label">How many pairs of clothes you want to donate?</label>
                            ...
                            <span className={`form-text invalid-feedback ${validation.vquantity}`} id="quantity">Have atleast 10 cloth pairs!</span>
                        </div>
                        <div className="mb-3">
                            <label htmlFor="desc" className="form-label">Cloth Description</label>
...
export default NewClothDonation 