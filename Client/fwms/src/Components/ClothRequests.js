...
function ClothRequests(props) {
  const obj=props.cdata;
  const flag=props.choice;
  let clothrequestslist;
  if(obj.length!=0){
    clothrequestslist=obj.map(cloth=>{
          ...
          <div className="row no-gutters">
            ...
            <div className="col-md-8">
              <div className="card-body">
                ...
                <p className="card-text " ><label className={`${liststyle.lm2} ${liststyle.text}`} htmlFor="username">Quantity:</label><label className={liststyle.lm1}>{cloth.quantity}</label></p>
                <p className="card-text"><label className={`${liststyle.lm2} ${liststyle.text}`} htmlFor="username">Requested Date:</label><label className={liststyle.lm1}>{cloth.request_date}</label></p>
            ...
            <div className="row no-gutters">
              ...
              <div className="col-md-8">
                <div className="card-body">
                  ...
                  {/* <p className="card-text"><label htmlFor="username">Total time from it's made:{food.timeofmade} hours</label></p> */}
                  <p className="card-text " ><label className={`${liststyle.lm2} ${liststyle.text}`} htmlFor="username">Quantity:</label><label className={liststyle.lm1}>{cloth.quantity}</label></p>
                  <p className="card-text"><label className={`${liststyle.lm2} ${liststyle.text}`} htmlFor="username">Request Date:</label><label className={liststyle.lm1}>{cloth.request_date}</label></p>
                  <p className="card-text"><label className={`${liststyle.lm2} ${liststyle.text}`} htmlFor="username">Request fullfilled Date:</label><label className={liststyle.lm1}>{cloth.requestfullfilled_date}</label></p>
                  <p className="card-text"><label className={`${liststyle.lm2} ${liststyle.text}`} htmlFor="username">Description:</label><label>{cloth.desc}</label></p>
